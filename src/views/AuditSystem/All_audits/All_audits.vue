        ...
        <div class="select-box">
          <el-form ref="form" :model="filterForm" size="mini" label="right" :inline="true">
                ...
                <el-form-item label="审核员" label-width="55px">
                  <el-select v-model="filterForm.region" style="width: 120px">
                    <el-option label="001" value="0"></el-option>
                    <el-option label="002" value="1"></el-option>
                    <el-option label="003" value="2"></el-option>
                  </el-select>
                </el-form-item>
            ...
            <el-dialog
               ...
               <el-button type="primary" @click.native="submitForm" size="big">确 定</el-button>
              </span>
                </el-dialog>
     <!--分页-->
      <el-row>
