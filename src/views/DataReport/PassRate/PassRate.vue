  ...
  <div class="PassRate">
    ...
    <div class="table-box">
      ...
      <el-table stripe
        ...
        <el-table-column prop="userCount" label="注册用户数(手机号码)" >
        </el-table-column>
        <el-table-column prop="adoptCount" label="实名认证数">
        </el-table-column>
        <el-table-column prop="operatorAdoptCount" label="运营商">
        </el-table-column>
        <el-table-column prop="zhimaAdoptCount" label="芝麻分">
        </el-table-column>
        <el-table-column prop="acceptCount" label="资料认证通过数(一审通过)">
        </el-table-column>
        <el-table-column prop="acceptPercentage" label="资料认证通过率">
        </el-table-column>
        <el-table-column prop="bankAdoptCount" label="绑卡">
        </el-table-column>
        <el-table-column prop="loanCount" label="放款人数">
        </el-table-column>
        <el-table-column prop="loanPercentage" label="放款率">
        </el-table-column>
      </el-table>
      <el-row>
        <el-col :span="24">
...
<script>
    export default {
      ...
      methods:{
        ...
        getInitPage(){
          this.$post('/CqStatisticsUser/dailyPassRate',{
