  ...
  <div class="PaymentAnalysis">
    ...
    <div class="table-box">
      ...
      <el-table stripe
        ...
        <el-table-column prop="urgeRepayCount" label="逾期还款笔数">
        </el-table-column>
        <el-table-column prop="urgeRepayAmount" label="逾期还款金额(元)" :formatter="amountFormat">
        </el-table-column>
        <el-table-column prop="urgeRepayPercentage" label="逾期还款占比">
        </el-table-column>
        <el-table-column prop="overdueAmount" label="逾期罚息" :formatter="amountFormat">
        </el-table-column>
        <el-table-column prop="newUrgeCount" label="逾期笔数（当月新增)">
        </el-table-column>
        <el-table-column prop="newUrgeAmount" label="逾期金额（当月新增)" :formatter="amountFormat">
        </el-table-column>
      </el-table>
      <el-row>
        <el-col :span="24">
...
<script>
    export default {
      ...
      methods:{
        ...
        getInitPage(){
          this.$post('/CqStatisticsOrderMonth/monthRepayAnalysis',{
