  ...
  <div class="Receiver">
    ...
    <div class="table-box">
      ...
      <el-table stripe
        ...
        <el-table-column prop="urgeName" label="催收人" >
        </el-table-column>
        <el-table-column prop="dayUrgeCount" label="当日分单">
        </el-table-column>
        <el-table-column prop="totalUrgeCount" label="持单总量">
        </el-table-column>
        <el-table-column prop="totalUrgeRepayCount" label="结清总单数">
        </el-table-column>
        <el-table-column prop="totalUrgeRepayAmount" label="结清总金额(元)" :formatter="amountFormat">
        </el-table-column>
        <el-table-column prop="urgeRepayCount" label="催回订单数/日">
        </el-table-column>
        <el-table-column prop="urgeRepayAmount" label="催回订单金额/日">
        </el-table-column>
        <el-table-column prop="urgeExtendCount" label="展期订单数">
        </el-table-column>
        <el-table-column prop="urgeExtendAmount" label="展期订单总金额(元)" :formatter="amountFormat">
        </el-table-column>
      </el-table>
      <el-row>
        <el-col :span="24">
...
<script>
    export default {
      ...
      methods:{
        ...
        getInitPage(){
          this.$post('/UserUrgeV2/receiverStatisticsInit',{
