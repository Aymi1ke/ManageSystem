  ...
  <div class="CoreReject">
    ...
    <div class="table-box">
      ...
      <el-table ref="InitDate"
        ...
        <el-table-column prop="loansResult" label="状态">
          <template slot-scope="scope">
            <el-tag :type="scope.row.loansResult=='10'?'success':'danger'">
              {{scope.row.loansResult =='10'?'通过':'拒绝'}}
            </el-tag>
          </template>
        </el-table-column>
        <el-table-column prop="extendPeriodTimes" label="重复申请">
        </el-table-column>
      ...
      <el-dialog
          ...
          <el-row :gutter="10">
            <el-col :span="12">
              ...
              <el-form-item label="银行卡号:" prop="bankName">
                <span>{{auditForm.bankName}}</span>
              </el-form-item>
              <el-form-item label="放款金额:" prop="truelyAmount" class="is-required">
                <span>{{auditForm.truelyAmount | amount}}</span>
              </el-form-item>
            ...
            <el-col :span="12">
              ...
              <el-form-item label="订单号:" prop="borrowId" >
        ...
        <span slot="footer" class="dialog-footer">
           <el-button  @click="AuditdialogVisible = false" size="big">取消</el-button>
               <el-button type="primary"  size="big" @click="Auditlend">确 定</el-button>
              </span>
      </el-dialog>
      <!--分页-->
      <el-row>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getInitPage(){
        this.$post('/CqBorrow/cqBorrowPageInit',{
