<template>
    ...
    <div class="select-box">
      <el-form ref="filterForm" :model="filterForm" size="mini" label="right" :inline="true">
            ...
            <el-form-item label="还款方式" label-width="70px">
              <el-select v-model="filterForm.repayType" placeholder="全部" style="width: 120px">
                <el-option label="快钱" value="10"></el-option>
                <el-option label="银行卡" value="20"></el-option>
                <el-option label="聚合" value="30"></el-option>
              </el-select>
            </el-form-item>

            <el-form-item label="实还款日期" label-width="85px">
              <el-date-picker
    ...
    <div class="table-box">
      ...
      <el-table ref="multipleTable"
        ...
        <el-table-column prop="repayAccount" label="还款账号">
        </el-table-column>
        <el-table-column prop="repayType" label="还款方式">
          <template slot-scope="scope">
            {{scope.row.repayType =='10'?'快钱':
            (scope.row.repayType =='20'?'银行卡':
            (scope.row.repayType =='30'?'聚合':''))}}
          </template>
        </el-table-column>
        ...
        <el-table-column prop="operate" label="操作">
          <template slot-scope="scope">
            <el-button   @click.native="handleHistroy(scope.row)"  size="mini">展期历史</el-button>
          </template>
        </el-table-column>
      </el-table>
...
<script>
    ...
    mounted(){
      ...
      getInitPage(){
        this.$post('/CqBorrow/paymentMadeInit',{
          ...
          repayType:this.filterForm.repayType,
