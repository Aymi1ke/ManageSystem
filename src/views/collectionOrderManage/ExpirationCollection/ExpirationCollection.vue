  ...
  <div class="ExpirationCollection">
    ...
    <div class="table-box">
      ...
      <el-table ref="multipleTable"
        ...
        <el-table-column prop="createTime" label="订单生成时间" :formatter="dateFormat">
        </el-table-column>
        <el-table-column prop="repayType" label="进度描述" >
          <template slot-scope="scope">
             {{scope.row.repayType == '10'? '还款':
            (scope.row.repayType == '20'? '展期':'')}}
          </template>
        </el-table-column>
        <el-table-column prop="loanCreateTime" label="放款日期" :formatter="dateFormat">
        </el-table-column>
        <el-table-column prop="repayTime" label="还款日期" :formatter="dateFormats">
        </el-table-column>
        <el-table-column prop="orderStart" label="订单进度状态">
          <template slot-scope="scope">
